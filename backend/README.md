...
## Project Structure
    ...
    ├── testapiautoteammem_112049  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_112049`
...
2. Clone this repo and `cd testapiautoteammem_112049`
